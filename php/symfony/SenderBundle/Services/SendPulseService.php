...
class SendPulseService
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this->apiUrl = $this->container->getParameter('sendpulse.host');
        $this->userId = $this->container->getParameter('sendpulse.user_id');
        $this->secret = $this->container->getParameter('sendpulse.secret');
        $this->refreshToken = 0;
        $this->apiFilesPath = '/tmp/';
